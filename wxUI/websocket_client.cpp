...
void spawn_client(const std::string& host, const std::string& port, const std::string& data)
{
    // The io_context is required for all I/O
    net::io_context ioc;

    // Launch the asynchronous operation
    std::make_shared<CWSSession>(ioc)->run(host.c_str(), port.c_str(), data.c_str());
